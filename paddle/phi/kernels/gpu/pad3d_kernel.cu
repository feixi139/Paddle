...
void Pad3dKernel(const Context& dev_ctx,
  ...
  if (use_int32_index) {
    ...
    int channels_int = static_cast<int>(channels);
    int in_depth_int = static_cast<int>(in_depth);
    int in_height_int = static_cast<int>(in_height);
    int in_width_int = static_cast<int>(in_width);
    int out_depth_int = static_cast<int>(out_depth);
    int out_height_int = static_cast<int>(out_height);
    int out_width_int = static_cast<int>(out_width);
    ...
    if (data_format == "NCDHW") {
      if (mode == "reflect") {
        ...
        Pad3DConstNCDHW<T, int32_t><<<grid, block, 0, stream>>>(out_size_int,
                                                                in_data,
                                                                num_int,
                                                                channels_int,
                                                                in_depth_int,
      ...
      if (mode == "reflect") {
        ...
        Pad3DConstNDHWC<T, int32_t><<<grid, block, 0, stream>>>(out_size_int,
                                                                in_data,
                                                                num_int,
                                                                channels_int,
                                                                in_depth_int,
